...
---@field auth_redirect_uri_port? integer: after authenticating, redirects to http://127.0.0.1:{auth_redirect_uri_port}/callback with auth code; default is 8888
...
M.setup = function(opts)
	...
	require("spotify.auth").authenticate(opts.client_id, opts.client_secret, scopes, redirect_uri_port)
